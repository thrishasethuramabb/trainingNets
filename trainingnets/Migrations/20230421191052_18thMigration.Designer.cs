...
namespace trainingnets.Migrations
{
    ...
    [Migration("20230421191052_18thMigration")]
            ...
            modelBuilder.Entity("trainingnets.Models.tblEmployeeTraining", b =>
                {
                    ...
                    b.Property<string>("tblUserAccountstrUsername")
                    ...
                    b.HasIndex("tblUserAccountstrUsername");
            ...
            modelBuilder.Entity("trainingnets.Models.tblEmployeeTraining", b =>
                {
                    ...
                    b.HasOne("trainingnets.Models.tblUserAccount", "tblUserAccount")
                        .WithMany()
                        .HasForeignKey("tblUserAccountstrUsername");
